...
<head>
	...
	<link rel="icon" type="image/png" href="<?= base_url('uploads/page_icon/not_found.jpg') ?>">
...
<body class="relative flex items-center justify-center min-h-screen bg-gray-900 text-white overflow-hidden">
	...
	<div
		...
		<!-- ❌ Title -->
		<h1 class="text-4xl font-extrabold text-yellow-400 mb-4 uppercase tracking-widest">404 Not Found</h1>
		<p class="text-gray-300 mb-6">Oops! The page you're looking for doesn't exist.</p>
		...
		<a href="<?= base_url(); ?>"
			...
			<span class="relative text-blue-200 uppercase text-sm tracking-wide"> Back to Home</span>
		</a>
	</div>
