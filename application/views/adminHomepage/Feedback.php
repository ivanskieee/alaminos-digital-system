        ...
        <div class="left-section space-y-6">
            <div class="bg-white shadow rounded-lg p-6">
                ...
                <?php if (!empty($feedbacks)) { ?>
                        ...
                        <table class="min-w-full divide-y divide-gray-200">
                            <thead class="bg-gray-100">
                                <tr>
                                    ...
                                    <th class="px-4 py-2 text-left text-xs font-semibold text-gray-600 uppercase">Message
                                    </th>
                                    <th class="px-4 py-2 text-left text-xs font-semibold text-gray-600 uppercase">Date
                                        Submitted</th>
                                    <th class="px-4 py-2 text-left text-xs font-semibold text-gray-600 uppercase">Action
                                    </th>
                                </tr>
                            </thead>
                            <tbody class="bg-white divide-y divide-gray-200">
                                <?php foreach ($feedbacks as $feedback) { ?>
                                    <tr class="hover:bg-gray-50">
                                        ...
                                        <td class="px-4 py-2 text-sm text-gray-800"><?= htmlspecialchars($feedback['name']); ?>
                                        </td>
                    ...
                    <!-- Card Layout for 2xl and Below -->
                    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 2xl:hidden">
                        <?php foreach ($feedbacks as $feedback) { ?>
                            <div class="user-card bg-white shadow-lg rounded-lg p-6 space-y-3">
