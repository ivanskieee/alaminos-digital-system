...
<body>
    ...
    <div class="main-container">
                    ...
                    <?php foreach ($users as $user): ?>
                        <div class="user-card bg-white p-4 rounded-lg shadow-md border border-gray-200">
                            <div class="flex items-center justify-between">
                                <h3 class="text-md font-semibold text-gray-700"><?= htmlspecialchars($user['username']); ?>
                                </h3>
                                <input type="checkbox" class="user-checkbox" value="<?= $user['id']; ?>"
                                    onchange="toggleUserSelection(this)">
                            </div>
        ...
        <!-- Right Section -->
        <div class="right-section bg-white border-l px-6 py-6 space-y-6 hidden xl:block">
            <!-- Section Title -->
