...
<body class="bg-custom">
    ...
    <header class="bg-custom-button text-white py-2 shadow-md">
        <div class="container mx-auto px-4 flex justify-between items-center">
            ...
            <nav>
                <a href="<?= base_url('auth') ?>" class="text-white hover:text-yellow-400 text-lg">Entry Page</a>
            </nav>
        </div>
    </header>
            ...
            <form action="<?php echo base_url('auth/contact_submit'); ?>" method="POST">
                <div class="mb-4">
                    ...
                    <input type="text" id="name" name="name"
                        class="w-full bg-gray-100 rounded border border-gray-300 focus:ring-2 focus:ring-green-400 focus:border-green-400 text-gray-700 py-2 px-4 outline-none transition duration-200 ease-in-out"
                ...
                <div class="mb-4">
                    ...
                    <textarea id="message" name="message"
                        class="w-full bg-gray-100 rounded border border-gray-300 focus:ring-2 focus:ring-green-400 focus:border-green-400 text-gray-700 py-2 px-4 h-32 resize-none outline-none transition duration-200 ease-in-out"
        ...
        document.addEventListener("DOMContentLoaded", function () {
            <?php if ($this->session->flashdata('success')): ?>
                Toastify({
                    ...
                    gravity: "top",
                    position: "right",
                    backgroundColor: "linear-gradient(to right,rgba(0, 30, 43, 0),rgb(20, 158, 189))",
            ...
            <?php if ($this->session->flashdata('error')): ?>
                Toastify({
                    ...
                    gravity: "top",
                    position: "right",
                    backgroundColor: "linear-gradient(to right,rgb(0, 0, 0),rgb(139, 9, 57))",
                    className: "rounded-lg shadow-lg",
                    stopOnFocus: true
                }).showToast();
            <?php endif; ?>
